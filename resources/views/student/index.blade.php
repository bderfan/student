...
<html>
   <head>
      ...
      <link rel="stylesheet" href="{{ asset('backend/css/bootstrap-extensions.css') }}">
       ...
       <div class="row">
        ...
        <table class="table table-secondary table-hover">
                ...
                <tr>
                   ...
                   <a class="btn btn-warning px-3 py-2" href="{{ route('student.delete',$student->id) }}">Delete Student</a> 
                   </td>
                </tr>
      ...
      <form method="post" action="{{ route('student.update',$student->id) }}">
					@csrf
                      ...
                      <div class="form-group py-2">
								    ...
								    <div class="controls">
									    <input type="text" name="name" id="name" class="form-control bg-white" required="" data-validation-required-message="This field is required" value="{{ $student->name }}"> 
                     ...
                     <div class="form-group py-2">
								    ...
								    <div class="controls">
									    <input type="email" name="email" id="email" class="form-control bg-white" required="" data-validation-required-message="This field is required" value="{{ $student->email }}"> 
                     ...
                     <div class="controls">
									    <input type="text" name="age" id="age" class="form-control bg-white" required="" data-validation-required-message="This field is required" value="{{ $student->age }}"> 
                      ...
                      <div class="form-group py-2">
								    <div class="controls">
									    <input type="text" name="phone_no" id="phone_no" class="form-control bg-white" required="" data-validation-required-message="This field is required" value="{{ $student->phone }}"> 
                          ...
                          <div class="form-group py-2">    
								    <div class="controls">
									    <textarea type="text" name="address" id="address" class="form-control bg-white" required="" data-validation-required-message="This field is required" style="height:150px;">{{ $student->address }}</textarea>
